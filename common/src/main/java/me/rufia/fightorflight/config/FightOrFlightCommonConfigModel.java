...
public class FightOrFlightCommonConfigModel implements ConfigData {
    ...
    public final boolean do_pokemon_attack = true;
    @Comment("Do especially aggressive Pokemon attack unprovoked?")
    public final boolean do_pokemon_attack_unprovoked = false;
    ...
    public final float neutral_threshold = 20f;
    @Comment("The value of the aggression if the Pokemon's level reaches 100.")
    public final float aggression_level_base_value = 40f;
    ...
    public final float aggression_level_multiplier = 1.0f;
    ...
    public final String[] always_flee = {
            "wimpod"
    };
    @Comment("Abilities that will reduce wild pokemon's aggro")
    public final String[] aggro_reducing_abilities = {
            "intimidate",
            "unnerve",
            "pressure"
    };
    ...
    public final String[] all_pokemon_targeting_whitelist = {
            "minecraft:villager"
    };
    @Comment("Whitelist for wild pokemon.")
    public final String[] wild_pokemon_targeting_whitelist = {

    };
    @Comment("Whitelist for player owned pokemon.(won't influence the Poke Staff)")
    public final String[] player_owned_pokemon_targeting_whitelist = {

    };
    @Comment("Allow the Pokemon to use the teleport move to flee if the Pokemon had learnt it?")
    public final boolean allow_teleport_to_flee = true;
    ...
    public final boolean do_player_pokemon_attack_other_players = false;
    @Comment("Can player Pokemon target other player's Pokemon?")
    public final boolean do_player_pokemon_attack_other_player_pokemon = false;
    ...
    public final boolean multiple_cries = true;
    ...
    public final int time_to_cry_again = 100;
    ...
    public final float experience_multiplier = 0.5f;
    @Comment("Your pokemon can gain EV points by killing a pokemon without a battle?")
    public final boolean can_gain_ev = true;
    ...
    public final boolean can_progress_use_move_evoluiton = true;
    ...
    public final int speed_stat_limit = 548;
    ...
    public final boolean activate_type_effect = false;
    ...
    public final int maximum_special_attack_stat = 200;
    ...
    public final boolean shouldOverrideHealthMechanic = true;
    @Comment("If you want to use the FOF style hp calculation.")
    public final boolean use_fof_style_hp_calculation = true;
    ...
    public final boolean force_enable_defend_owner = true;
    ...
    public final boolean force_enable_defend_self = true;
}
