...
public class PokemonAreaEffectMagicModel<T extends Entity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bottom = partdefinition.addOrReplaceChild("bottom", CubeListBuilder.create().texOffs(-16, 0).addBox(-8.0F, 0.0F, -8.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition effect_beam_1 = partdefinition.addOrReplaceChild("effect_beam_1", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition beam_1_r1 = effect_beam_1.addOrReplaceChild("beam_1_r1", CubeListBuilder.create().texOffs(0, 16).addBox(-8.0F, 5.0F, -1.0F, 16.0F, 32.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -5.0F, -1.0F, 0.0F, 2.3562F, 0.0F));

        PartDefinition beam_0_r1 = effect_beam_1.addOrReplaceChild("beam_0_r1", CubeListBuilder.create().texOffs(0, 16).addBox(-9.0F, 5.0F, 1.0F, 16.0F, 32.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, -2.0F, 0.0F, 0.7854F, 0.0F));
